...
const addPurchases = (arr) => {
  const totalPurchases = arr.reduce((accumulator, currentValue) => {    
...
const countNumberOfElements = (arr) => {
  const numOfElements = arr.reduce((accumulator, currentValue,idx) => {    
...
const returnNames = (arr) => {
  let starWarsNames = arr.reduce((accumulator, currentValue,) => {
...
const reversedString = (str) => {
  ...
  const reverseArr = newArr.reduce((accumulator, currentValue,) => {    
     accumulator += currentValue       
     return accumulator ;    
  }, '');
